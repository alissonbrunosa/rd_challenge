...
var Analytics = function () {
  function Analytics() {
    ...
    this.service = new _service2.default('http://localhost:30001');
    this.visitor = _storage2.default.get('visitor') || this.init_visitor();
  }

  _createClass(Analytics, [{
    key: 'init_visitor',
    value: function init_visitor() {
      return {
        email: null,
        views: []
      };
    ...
    value: function register(url) {
      var view = new _view2.default(url, (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss'));
      var views = this.visitor.views;

      views.push(view);
      if (this.visitor.email) {
        this.service.saveVisitor(this.visitor, function (response) {
          _storage2.default.add('visitor', response.data);
        });
      } else {
        _storage2.default.add('visitor', this.visitor);
      }
    }
  }, {
    key: 'send',
    value: function send(email, callback) {
...
},{"./service":30,"./storage":31,"./view":32,"moment":26}],29:[function(require,module,exports){
"use strict";
...
var analytics = new _analytics2.default();
window.addEventListener('load', function (event) {
  analytics.register(event.target.URL);
  var forms = document.getElementsByTagName('form');
  forms = Array.prototype.slice.call(forms);
  forms.forEach(function (form) {
    var email_field = form.querySelector('input[type="email"]');
    if (email_field) {
      form.addEventListener('submit', function (event) {
        event.preventDefault();
        analytics.send(email_field.value, function () {
          event.target.submit();
        });
      });
    }
...
},{"./analytics":28}],30:[function(require,module,exports){
'use strict';
...
var Service = function () {
  ...
  _createClass(Service, [{
    key: 'saveVisitor',
    value: function saveVisitor(visitor, success) {
      _axios2.default.post(this.base + '/visitors.json', visitor).then(success).catch(function (error) {
        console.log(error);
      });
    }
  }]);
...
var Storage = function () {
  ...
  _createClass(Storage, [{
    ...
    value: function get(key) {
      var str_obj = this.store.getItem(key);
...
var View = function View(url, datetime) {
