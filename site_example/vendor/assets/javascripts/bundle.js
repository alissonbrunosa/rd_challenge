...
var Analytics = function () {
  function Analytics(url) {
    ...
    this.url = url;
    this.views = _storage2.default.get('views') || [];
  }

  _createClass(Analytics, [{
    key: 'register',
    value: function register(url) {
      this.views.push(new _view2.default(url, (0, _moment2.default)().format('YYYY-MM-DD HH:mm:ss')));
      this.views = _lodash2.default.uniqBy(this.views, 'url');
      _storage2.default.add('views', this.views);
    }
  }, {
    key: 'send',
    value: function send(email) {
      ...
      _axios2.default.post(this.url, data).then(function (response) {}).catch(function (error) {
        console.log(error);
      });
    }
  }]);
...
},{"./storage":31,"./view":32,"axios":1,"lodash":26,"moment":27}],30:[function(require,module,exports){
"use strict";
...
var analytics = new _analytics2.default('http://localhost:30001/visitors.json');
...
},{"./analytics":29}],31:[function(require,module,exports){
"use strict";
